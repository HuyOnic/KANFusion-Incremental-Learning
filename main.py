...
def setup_parser():
    ...
    parser.add_argument('--incre_cls', type=int, default=2, help="Number classes per task")
    ...
    parser.add_argument('--init_epochs', type=int, default=5, help="Number epochs of first task")
